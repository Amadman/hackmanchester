...
<body id="home">
    ...
    <div class="intro-header">
		<div class="col-xs-12 text-center abcen1">
			<h1 class="h1_home wow fadeIn" data-wow-delay="0.4s">spent</h1>
			<h3 class="h3_home wow fadeIn" data-wow-delay="0.6s">Spend More. Get More.</h3>
			<ul class="list-inline intro-social-buttons">
				<li><a href="login.php" class="btn  btn-lg mybutton_cyano wow fadeIn" data-wow-delay="0.8s"><span class="network-name">Sign In</span></a>
				</li>
  ...
  <div id="register" class="content-section-c ">
    <div class="container">
      ...
      <div class="row">
        ...
        <h2>Register</h2>
        <p class="lead" style="margin-top:0">Get 100 free points!</p>
        </div>
            ...
            <div class="morph-button wow pulse morph-button-inflow morph-button-inflow-1">
              ...
              <div class="morph-content">
                <div class="content-style-form content-style-form-4 ">
                  <h2 class="morph-clone">Register</h2>
                  <form method="post" action="register.php">
                    ...
                    <p><label>Referral</label><input type="text" name="referral"/></p>
